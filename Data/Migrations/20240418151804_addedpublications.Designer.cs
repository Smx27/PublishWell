...
namespace JPS.Data.Migrations
{
    ...
    [Migration("20240418151804_addedpublications")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PublishWell.Data.Entities.Categorie", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("PublishWell.Data.Entities.Publication", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("PublishWell.Data.Entities.PublicationCategorie", b =>
                {
            ...
            modelBuilder.Entity("PublishWell.Data.Entities.PublicationComment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("PublishWell.Data.Entities.PublicationLike", b =>
                {
            ...
            modelBuilder.Entity("PublishWell.Data.Entities.PublicationTag", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("PublishWell.Data.Entities.PublicationView", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("PublishWell.Data.Entities.PublicationCategorie", b =>
                {
                    b.HasOne("PublishWell.Data.Entities.Categorie", "Categorie")
                        .WithMany("Publications")
                        .HasForeignKey("CategorieId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PublishWell.Data.Entities.Publication", "Publication")
                        .WithOne("PublicationCategory")
                        .HasForeignKey("PublishWell.Data.Entities.PublicationCategorie", "PublicationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
